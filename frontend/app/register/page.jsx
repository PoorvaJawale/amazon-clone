    ...
    <div className="min-h-screen bg-white flex flex-col items-center pt-8">
      ...
      <div className="w-full max-w-sm border border-[#d5d9d9] rounded-lg p-6 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {[
            { label: "Your name", key: "full_name", type: "text" },
            { label: "Mobile number or email", key: "email", type: "email" },
            { label: "Password", key: "password", type: "password" },
            { label: "Re-enter password", key: "confirm", type: "password" },
          ].map(({ label, key, type }) => (
            <div key={key}>
        ...
        <div className="mt-4 text-sm">
          ...
          <Link href="/login" className="text-[#0066c0] hover:text-[#c45500] hover:underline">Sign in</Link>
        </div>
      </div>
